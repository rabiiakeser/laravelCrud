              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$pro->price}}</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$pro->description}}</p>
                      </td>
                 
                      
                       <td class="align-middle">
                        <a href="{{ route('product.edit', ['product' => $pro->id]) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
